...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Common\Http\Middleware\SetPerPageLimitMiddleware::class,
        /**GLOBAL MIDDLEWARE**/
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Common\Http\Middleware\DashboardAccessMiddleware::class,
            \App\Common\Http\Middleware\MarkNotificationRead::class,
            \App\Common\Http\Middleware\HandleInertiaRequests::class,
            \App\Common\Http\Middleware\ActiveUserMiddleware::class,
            \App\Common\Http\Middleware\BlockIpMiddleware::class,
            /**WEB MIDDLEWARE**/
        ],
