    ...
    <WebsiteLayout>
        ...
        <div class="body">
            <div class="container px-5">
                <div class="row">
                    <div class="col-3" >
                        <p class="h2 department_title" href="#">Departments</p>
                        <ul class="departments m-0 p-0">
                            <li v-for="(department,index) in departments" :key="index">
                                <Link :class="{'active': request.id == department.id}"  :href="$route('faqs.department', department.id)">{{ department.name }}</Link>
                            </li>
                        </ul>
                    </div>
                    <div class="col text-center" >
                        <h3 class="faq_title">faq</h3>
                        <h3 class="faq_subtitle">{{ department.name }}</h3>
